# Meitav Provident Fund Application Portal

A Hebrew language web application for submitting provident fund (קופת גמל) applications to Meitav (מיטב דש) investment house. The server accepts the form, uploads the attachment, and calls the webhook with the `Process this provident fund application` message and the attachment id.

This is a provident fund application system for Meitav (מיטב דש) investment house.
